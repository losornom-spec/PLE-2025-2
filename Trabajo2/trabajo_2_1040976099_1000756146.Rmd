...
En cada una de estas, si la persona asistió a una dependencia entonces se sumará una unidad a una nueva varible llamada Prevention, así el que no haya consultado ninguna tendrá el valor de 0 y el que las haya consultado a todas tendrá el valor de 5. Los demás valores serán entre 0 y 5. 
...
- Se observa una tendencia ligeramente creciente en la mediana del ingreso a medida que aumenta la Puntuación de Prevention, especialmente al pasar de 0 a 5. Esto sugiere que los hogares con mayores ingresos tienen una ligera tendencia a realizar más consultas (mayor Prevention), lo que se asocia con una mayor preocupación o capacidad para actuar en materia de salud preventiva.

- La longitud de la caja es similar en todos los grupos, lo que indica que la variabilidad de los ingresos de la mitad central de las familias (entre el percentil 25 y 75) es relativamente constante independientemente de su nivel de Prevention.
...
**Conclsuiones finales del trabajo**
